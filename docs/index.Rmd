...
By using an if-else statement I find that there are no NA's. The data contains 18 variables, and I consider the purchase variable the variable of main interest. It only takes two values, and I transform it to take either 1 or 0, 1 for the brand "MM" and 0 for the "CH" brand. 
```{r, warning = FALSE, message=FALSE}
...
For the numeric variables, I produce a heatmap to get an idea of the correlations. 
```{r, warning =FALSE, message=FALSE}

# A for loop to transform some variables into factors

var_list <- c("Purchase", "StoreID", "SpecialCH", "SpecialMM", "STORE")
